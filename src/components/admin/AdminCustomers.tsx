...
import { Plus, Trash2, Save, Search, Crown, Percent, Mail, Phone, User, RefreshCw } from "lucide-react";
...
const AdminCustomers = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Select All */}
      {filteredCustomers.length > 0 && selectedIds.length === 0 && (
      ...
      <div className="space-y-3">
        {filteredCustomers.map((customer) => (
          <Card key={customer.id} className="bg-card border-border hover:border-gold/50 transition-colors">
